Shader "OvrAvatar/AvatarSurfaceShader" {
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma target 3.0
// Disabled by Shader Control: #pragma multi_compile PROJECTOR_OFF PROJECTOR_ON
// Disabled by Shader Control: #pragma multi_compile NORMAL_MAP_OFF NORMAL_MAP_ON
// Disabled by Shader Control: #pragma multi_compile PARALLAX_OFF PARALLAX_ON
// Disabled by Shader Control: #pragma multi_compile ROUGHNESS_OFF ROUGHNESS_ON
// Disabled by Shader Control: #pragma multi_compile VERTALPHA_OFF VERTALPHA_ON
// Disabled by Shader Control: #pragma multi_compile LAYERS_1 LAYERS_2 LAYERS_3 LAYERS_4 LAYERS_5 LAYERS_6 LAYERS_7 LAYERS_8
